...
class PPO2(ActorCriticRLModel):
    ...
    """
    def __init__(self, policy, env, gamma=0.99, n_steps=256, ent_coef=0.00001, learning_rate=2.5e-4, vf_coef=0.5,
                 max_grad_norm=0.5, lam=0.95, nminibatches=8, noptepochs=8, cliprange=0.2, cliprange_vf=None,
...
class Runner(AbstractEnvRunner):
    ...
    def _run_one(self, env_idx):
        ...
        for _ in range(self.n_steps):
            ...
            self.scores[env_idx].append([rewards])
