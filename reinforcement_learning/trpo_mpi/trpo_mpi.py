...
import reinforcement_learning.common.tf_util as tf_util
from reinforcement_learning.common.tf_util import total_episode_reward_logger
from reinforcement_learning.common import explained_variance, zipsame, dataset, fmt_row, colorize, ActorCriticRLModel, \
...
from reinforcement_learning.common.cg import conjugate_gradient
from reinforcement_learning.common.policies import ActorCriticPolicy
from reinforcement_learning.common.misc_util import flatten_lists
from reinforcement_learning.common.runners import traj_segment_generator
from reinforcement_learning.trpo_mpi.utils import add_vtarg_and_adv
...
class TRPO(ActorCriticRLModel):
    ...
    """
    def __init__(self, policy, env, gamma=0.99, n_steps=1024, max_kl=0.01, cg_iters=10, lam=0.98,
        ...
        self.timesteps_per_batch = n_steps
