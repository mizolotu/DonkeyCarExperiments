...
class DDPG(OffPolicyRLModel):
    ...
    def __init__(self, policy, env, gamma=0.99, memory_policy=None, eval_env=None, nb_train_steps=200,
                 ...
                 render=False, render_eval=False, memory_limit=None, buffer_size=10000, random_exploration=0.0,
    ...
    def setup_model(self):
        with SetVerbosity(self.verbose):
            ...
            assert isinstance(self.action_space, reinforcement_learning.gym.spaces.Box), \
